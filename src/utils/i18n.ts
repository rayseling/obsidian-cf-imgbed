...
const translations: Record<Language, Translations> = {
	zh: {
		...
		notices: {
			...
			uploadPlaceholderLost: '上传已完成，但占位符已被删除，未插入任何内容：{content}',
			...
			uploadFailedStashedAuto: '上传失败，图片已暂存到 {path}，自动上云稍后会补传',
			uploadFailedStashedManual: '上传失败，图片已暂存到 {path}。请稍后执行“上传当前文档所有图片”补传',
			uploadFailedStashFailed: '上传失败，且图片无法暂存到库中，本次图片未保存',
	...
	en: {
		...
		notices: {
			...
			uploadPlaceholderLost: 'Upload finished but its placeholder is gone, nothing was inserted: {content}',
			...
			uploadFailedStashedAuto: 'Upload failed; the image was saved to {path} and auto-upload will retry it later',
			uploadFailedStashedManual: 'Upload failed; the image was saved to {path}. Run “Upload current note images” later to retry',
			uploadFailedStashFailed: 'Upload failed and the image could not be saved to the vault; it was not kept',
